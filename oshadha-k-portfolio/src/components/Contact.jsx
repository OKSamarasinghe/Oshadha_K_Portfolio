  ...
  return (    <div className="container mx-auto px-6 md:px-12 lg:px-16 xl:px-20 py-20">
      ...
      <div className="max-w-3xl mx-auto">
        <p className="text-center text-lg text-slate-300 mb-8">
          I'm currently looking to join a <span className="text-[#7F5FFF] font-medium">cross-functional team</span> that values improving people's lives through accessible design. Or have a project in mind? Let's connect!
        </p>
        
        <div className="text-center mb-12">
          <a href="mailto:oshadhanayanamith@gmail.com" className="text-lg text-slate-300 hover:text-[#7F5FFF] transition duration-300">
            oshadhanayanamith@gmail.com
          </a>
        </div>
        ...
        <div className="flex justify-center mt-12 space-x-6">
          <a href="#" className="text-slate-300 hover:text-[#7F5FFF] transition duration-300">
